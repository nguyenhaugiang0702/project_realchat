    ...
    <div class="col-xl-4 col-sm-12 col-md-6 offset-md-4">
      <div class="signup-card">
                      ...
                      if ($file_size > 1048567) {
                        ...
                        if (in_array($file_ext, $permited) === false) {
                          ...
                          if ($res) {
                            ...
                            $query = "INSERT INTO user(img, username, email, pass, status)VALUES('$uploaded_image', '$uname', '$mail', '$crypt', '$status')";
                            $res = $db->insert($query);
                            if ($res) {
        ...
        <form method="POST" enctype="multipart/form-data">
          ...
          <a href="index.php" class="btn btn-sm btn-info text-light">Log In</a>
        </form>
      </div>
    </div>
  </div>
